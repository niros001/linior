...
const Wallet= () => {
    ...
    return (
        <div>
          {isAuthenticated && <div>Logged in as: {account}</div>}
          {isAuthenticated && <button onClick={logOut} disabled={isAuthenticating}>Logout</button>}
          <br />
            <div className="row">
                <div className="col-lg-3 mb30" onClick={login}>
